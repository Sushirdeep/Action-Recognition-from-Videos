...
for i = 1:length(C_values)
    % Performing 5 fold cross vaalidation
     ...
     t = templateSVM('Standardize',0,'KernelFunction','linear', 'BoxConstraint', C);      
     
     SVMMulticlass_combn = fitcecoc(featureBag_combn, action_labels, 'Coding', 'onevsall',...
                                          'Learners', t); 
...
t = templateSVM('Standardize',0,'KernelFunction','linear', 'BoxConstraint', C_opt);

SVMMulticlass_action = fitcecoc(featureBag_train, class_train, 'Coding', 'onevsall',...
                                    'Learners',t); 
